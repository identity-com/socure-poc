...
[[ $STAGE = "prod" ]] && ACCESS_IDENTITY="E13VH96WYU0CFA" || ACCESS_IDENTITY="?"
[[ $STAGE = "prod" ]] && HOSTED_ZONE_ID="Z01073574EZAII1CFU1I" || HOSTED_ZONE_ID="Z012078129CDW83TJ2O5Q"
[[ $STAGE = "prod" ]] && CERTIFICATE_ARN="${PROD_ACCOUNT_CERTIFICATE_ARN}" || CERTIFICATE_ARN="${DEV_ACCOUNT_CERTIFICATE_ARN}"

[[ $STAGE = "prod" ]] && DOMAIN_PREFIX="socure-demo" || DOMAIN_PREFIX="socure-demo-${STAGE}"
PROJECT="SocureDemo"
