    ...
    UpdateMetadataInterface
{
    ...
    public static function makeHttpClient(
        ...
        $stack = \Automattic\WooCommerce\GoogleListingsAndAds\Vendor\GuzzleHttp\HandlerStack::create();
        $stack->push($middleware);

        return new \Automattic\WooCommerce\GoogleListingsAndAds\Vendor\GuzzleHttp\Client([
            'handler' => $stack,
            'auth' => 'google_auth',
        ] + $httpClientOptions);
    }
